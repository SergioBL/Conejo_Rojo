...
public class Practica_3_DBA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        vehiculo1 = new Vehiculo(new AgentID("vehiculo13"));
        vehiculo2 = new Vehiculo(new AgentID("vehiculo14"));
        vehiculo3 = new Vehiculo(new AgentID("vehiculo15"));
        vehiculo4 = new Vehiculo(new AgentID("vehiculo16"));
        vehiculo1.start();
        vehiculo2.start();
        vehiculo3.start();
        vehiculo4.start();
